...
class ICard9a extends StatefulWidget {
  ...
  ICard9a({this.color = Colors.grey, this.price = "", this.priceTitleStyle, this.title1 = "", this.title1Style,
  ...
  @override
  _ICard9aState createState() => _ICard9aState();
}

class _ICard9aState extends State<ICard9a>{
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: IBox(child: _item2(), radius: 0, blur: 10),
    );
  }
        ...
        child: Container(
          ...
          child: Stack(
            children: <Widget>[
              ...
              Container(
                  margin: EdgeInsets.only(left: widget.width*0.35),
                  width: widget.width*0.63,
                  height: widget.height,
                  child: Column(
